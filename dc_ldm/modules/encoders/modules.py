...
from dc_ldm.modules.x_transformer import Encoder, \
...
class FrozenImageEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="C:/Users/10781/Desktop/dd-备份/ddcode/openai/clip-vit-large-patch14", device="cuda", max_length=77):
        super().__init__()
